...
public class MainActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNavigationDrawerFragment.setUserData(getResources().getString(R.string.app_name), getResources().getString(R.string.copyright), BitmapFactory.decodeResource(getResources(), R.drawable.ic_logo_app));
    }
